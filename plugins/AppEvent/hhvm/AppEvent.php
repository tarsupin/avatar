...
/****** Create Calendar ******/
	...
	(
		string $title			// <str> The name of the calendar.
	,	int $startyear		// <int> The start year of the calendar.
	,	int $startmonth		// <int> The start month of the calendar.
	,	int $startday		// <int> The start day of the calendar.
	,	int $duration		// <int> The duration of the calendar in days.
	): int					// RETURNS <int> the ID of the new calendar, or 0 if failed.
...
/****** Edit Calendar Entry ******/
	...
	(
		int $cal_id			// <int> The ID of the calendar.
	,	int $year			// <int> The year of the day to edit.
	,	int $month			// <int> The month of the day to edit.
	,	int $day			// <int> The day to edit.
...
/****** Get available items from Calendar ******/
	...
	(
		int $cal_id		// <int> The ID of the calendar.
	,	int $year		// <int> The year of the day to retrieve.
	,	int $month		// <int> The month of the day to retrieve.
...
/****** Claim item from Calendar ******/
	...
	(
		int $cal_id			// <int> The ID of the calendar.
	,	int $item_id		// <int> The ID of the item to claim.
	,	string $cal_title = ''	// <str> The name of the calendar to avoid unnecessary queries.
	): bool					// RETURNS <bool> TRUE on success, FALSE on failure.
