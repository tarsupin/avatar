...
/****** Add an item to an Outfit ******/
	...
	,	bool $forcedown = false	// <bool> Whether to force an item below the base. Needed when used through sortAll().
	): array						// RETURNS <array> the array of the outfit.
...
/****** Unequip an item from an Outfit ******/
	...
	): array			// RETURNS <array> the outfit (after unequipping everything).
...
/****** Move an item to the left or right ******/
	...
	(
		array $outfitArray	// <array> The array of the outfit to update.
	,	int $itemID			// <int> The ID of the item to move.
	,	string $direction		// <str> left or right (meaning up or down)
	): array					// RETURNS <array> the array of the outfit, or array() if failed.
...
/****** Decide which parts of item images need to be erased ******/
	...
	): array					// RETURNS <array> of upper left coordinates and size of the rectangles to erase from the respective positions.
...
/****** Draw an Avatar from an Outfit ******/
	...
	,	string $gender			// <str> The gender to use.
	,	array $outfitArray	// <array> The outfit that you want to draw.
	,	string $location = ""	// <str> The location to save the image in.
	): void					// RETURNS <void>
...
/****** Reorder and check outfit code ******/
	...
	,	string $type = "preview"	// <str> The type of outfit.
	): array						// RETURNS <array> the sorted and checked outfit data.
...
/****** Reorder and check outfit code ******/
	...
	(
		int $uniID			// <int> The Uni-Account.
	,	int $itemID			// <int> The ID of the item to be removed from outfits.
	): void					// RETURNS <void>
