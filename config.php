...
define("SITE_SALT", "3iG~r?hw6.rCQWz+H<lVF8!xn`(bMBJMW:Jlk6)9mpuo9:|z Y/|O[u4}aNr:!");
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://avatar.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "avatar.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://avatar.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "avatar.test";
	$config['admin-email'] = "info@avatar.test";
